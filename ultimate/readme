...
You can find the code here: [`find_persistent_homology_by_cnn.py`](./find_persistent_homology_by_cnn.py)

- [`NNtopo_incorporated.txt`](./NNtopo_incorporated.txt): Highlights the integration of topological loss. This is just given to show which part was necessary for this work, it is already in above codes for the different models.
